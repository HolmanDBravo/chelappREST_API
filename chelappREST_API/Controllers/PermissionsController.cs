...
namespace chelappREST_API.Controllers
{
    ...
    public class PermissionsController : ControllerBase
    {
        ...
        public PermissionsController(IDocumentClient documentClient, IConfiguration configuration)
        {
        ...
        [HttpGet]
        public IQueryable<PermissionsViewModel> Get()
        {
            return _documentClient.CreateDocumentQuery<PermissionsViewModel>(UriFactory.CreateDocumentCollectionUri(databaseId, collectionId),
                new FeedOptions { MaxItemCount = 20 });
        }

        [HttpGet("{id}")]
        public IQueryable<PermissionsViewModel> Get(int id)
        {
            return _documentClient.CreateDocumentQuery<PermissionsViewModel>(UriFactory.CreateDocumentCollectionUri(databaseId, collectionId),
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] PermissionsViewModel item)
        {
