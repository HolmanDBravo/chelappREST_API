...
namespace chelappREST_API.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public RolesController(IDocumentClient documentClient, IConfiguration configuration)
        {
        ...
        [HttpGet]
        public IQueryable<RolesViewModel> Get()
        {
            return _documentClient.CreateDocumentQuery<RolesViewModel>(UriFactory.CreateDocumentCollectionUri(databaseId, collectionId),
                new FeedOptions { MaxItemCount = 20 });
        }

        [HttpGet("{id}")]
        public IQueryable<RolesViewModel> Get(int id)
        {
            return _documentClient.CreateDocumentQuery<RolesViewModel>(UriFactory.CreateDocumentCollectionUri(databaseId, collectionId),
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] RolesViewModel item)
        {
