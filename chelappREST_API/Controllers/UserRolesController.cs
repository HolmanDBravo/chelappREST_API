...
namespace chelappREST_API.Controllers
{
    ...
    public class UserRolesController : ControllerBase
    {
        ...
        public UserRolesController(IDocumentClient documentClient, IConfiguration configuration)
        {
        ...
        [HttpGet]
        public IQueryable<UserRolesViewModel> Get()
        {
            return _documentClient.CreateDocumentQuery<UserRolesViewModel>(UriFactory.CreateDocumentCollectionUri(databaseId, collectionId),
                new FeedOptions { MaxItemCount = 20 });
        }

        [HttpGet("{id}")]
        public IQueryable<UserRolesViewModel> Get(int id)
        {
            return _documentClient.CreateDocumentQuery<UserRolesViewModel>(UriFactory.CreateDocumentCollectionUri(databaseId, collectionId),
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(string id, [FromBody] UserRolesViewModel item)
        {
